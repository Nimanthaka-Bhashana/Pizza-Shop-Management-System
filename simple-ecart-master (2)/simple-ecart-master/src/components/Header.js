        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <Link to="Dashboard" className={`nav-link ${darkMode? 'text-dark-primary' : 'text-light-primary'}`}>
              Home 
              
              </Link>
              <Link to="Menu" className={`nav-link ${darkMode? 'text-dark-primary' : 'text-light-primary'}`}>
              Menu
              </Link>
              <Link to="About" className={`nav-link ${darkMode? 'text-dark-primary' : 'text-light-primary'}`}>
              About
              </Link>
              <Nav.Link 
